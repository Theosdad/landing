...
Москва, Россия — ИТ-компании «СИСТЕМНЫЕ РЕШЕНИЯ» и «Платформа Боцман» (входит в «Группу Астра») объявили о <a href="/assets/pdf/Сертификат_совместимости_Боцман_moncloud_signed.pdf">подтверждении совместимости </a> и корректности работы облачной платформы moncloud и платформы контейнеризации «Боцман»
